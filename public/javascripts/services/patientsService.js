angular.module('KOL').service('patients', ['$http', function($http){
  ...
  //This service has different http functions to complete a complete CRUD functionality. 
  //This factory was made, because some of the controllers share the need for multiple functions within the CRUD.
